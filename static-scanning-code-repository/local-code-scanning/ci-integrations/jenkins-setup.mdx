...
<Frame>
  <img src="/images/static-scanning-code-repository/local-code-scanning/jenkins-intro.png" alt="Jenkins Local Scanning Intro" style={{ borderRadius: '0.5rem' }} />
</Frame>

## Requirements

1. **API Key**  
   Follow [Introduction & API Key Creation](/static-scanning-code-repository/local-code-scanning/introduction-api-key) to generate and store a key in Jenkins credentials.
2. **Operating System**  
