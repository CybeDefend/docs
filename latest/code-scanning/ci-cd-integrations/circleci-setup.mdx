...
1. **API Key**  
   Create one via [Introduction & API Key Creation](/latest/code-scanning/local-code-scanning/introduction-api-key). Store it in **Project Settings → Environment Variables** (e.g. `CYBEDEFEND_API_KEY`).
2. **Branch Filters**  
