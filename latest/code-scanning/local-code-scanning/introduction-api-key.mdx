...
- **Learn the CLI Options**: Head to [CLI Options for Local Scanner](/latest/code-scanning/local-code-scanning/cli-options) for usage details.
- **Install for Your OS**: Follow the OS-specific tutorials ([Mac Setup](/latest/code-scanning/local-code-scanning/mac-setup), [Windows Setup](/latest/code-scanning/local-code-scanning/windows-setup), [Linux Setup](/latest/code-scanning/local-code-scanning/linux-setup)) to get started.
