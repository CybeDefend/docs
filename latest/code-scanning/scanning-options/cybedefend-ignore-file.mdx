...
|-----------|----------------------------|
| SAST (Opengrep, Bandit) | Yes |
| IaC (Kics, Checkov) | Yes |
| **Secret (Gitleaks)** | **Yes** |
| CI/CD | Yes |
...
If you want a file out of SAST but still watched for secrets, exclude the specific findings with [inline `cybedefend-ignore` comments](/latest/code-scanning/scanning-options/inline-ignore-comments) instead of listing the file here.
