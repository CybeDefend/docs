...
A repository scanned through a **GitHub** or **GitLab** integration must hold at most **5 GiB of uncompressed content** — the files on the branch you scan, not the size of the compressed download.

Above that limit the scan stops before any scanner runs, and the project reports *"We could not process the repository archive. It may be too large or not a valid archive."*
