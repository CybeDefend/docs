---
title: "Cybe Analysis - Complete Guide"
...
When Cybe Analysis identifies a false positive:

- **Status is automatically updated** to "False Positive"
- **Detailed explanation** is added as a comment
- **Reasoning is provided** based on code context and data flow analysis
...
Each analyzed vulnerability receives a comment from Cybe explaining:

- **What was found**: Clear description of the security issue
- **Context analysis**: How the vulnerability exists in your code
- **Risk assessment**: Real-world exploitability evaluation
- **Recommendation**: Whether it's a true positive, false positive, or requires review
...
- [Cybe AutoFix](/v103/agent-ai-integration/cybe-autofix-detail) - Automatically fix detected vulnerabilities
- [Cybe Security Champion](/v103/agent-ai-integration/cybe-security-champion-detail) - Chat with your vulnerabilities
- [AI Usage Tracking](/v103/plateform-overview/plan-&-pricing/ai-usage-tracking) - Monitor your AI credits

<Info>
Questions about Cybe Analysis? Contact us at [contact@cybedefend.com](mailto:contact@cybedefend.com).
</Info>
