...
With the **GitLab** integration enabled, you'll be able to:

- **Scan your codebase** automatically for vulnerabilities (SAST).  
- **Quickly set up** new projects without manual ZIP uploads.  
- **Use advanced features** like auto-generated merge request fixes with Cybe AutoFix.
...
- [Connect GitHub Account](/v103/get-started/connect-your-source-code/connect-github)
- [Create a Project](/v103/get-started/project-management/create-project)
- [Cybe AutoFix](/v103/agent-ai-integration/cybe-autofix-detail)
