...
1. **API Key**  
   Create one via [Introduction & API Key Creation](/v103/code-scanning/local-code-scanning/introduction-api-key). Store it in **Project Settings → Environment Variables** (e.g. `CYBEDEFEND_API_KEY`).
2. **Branch Filters**  
