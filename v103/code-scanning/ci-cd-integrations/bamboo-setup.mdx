...
- **API Key**: Create one via [Introduction & API Key Creation](/v103/code-scanning/local-code-scanning/introduction-api-key) and store it in **Plan Variables** (e.g. `CYBEDEFEND_API_KEY`).  
