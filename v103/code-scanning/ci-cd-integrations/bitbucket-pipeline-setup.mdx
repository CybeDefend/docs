...
- **API Key**: [Create it](/v103/code-scanning/local-code-scanning/introduction-api-key) and store in Bitbucket’s **Repository Settings → Pipelines → Repository Variables**.
