...
1. **API Key**  
   Ensure you’ve already created an API key in the CybeDefend dashboard. If not, see [Introduction & API Key Creation](/v103/code-scanning/local-code-scanning/introduction-api-key).
2. **CybeDefend CLI**  
