...
## Prerequisites
  ...
  - **API Key**: [Create and store](/v103/code-scanning/local-code-scanning/introduction-api-key) it in your repository's **Settings → Secrets** → **Actions** (e.g., `CYBEDEFEND_API_KEY`).
