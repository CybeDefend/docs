...
2. **Personal Access Token (Classic)**: Token with `read:packages` scope
...
When connecting your GitHub Container Registry in CybeDefend, you'll need to provide:

| Field | Description | Example |
|-------|-------------|---------|
| **Nom d'utilisateur GitHub** | Your GitHub username or organization | `myorg` |
| **Personal Access Token** | GitHub PAT with `read:packages` scope | `ghp_xxxxxxxxxxxx` |
| **Description** | Optional description for the registry | `Registry GitHub de production` |
