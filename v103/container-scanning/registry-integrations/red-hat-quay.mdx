...
2. **Robot Account**: Robot account with repository read access
...
When connecting your Red Hat Quay registry in CybeDefend, you'll need to provide:

| Field | Description | Example |
|-------|-------------|---------|
| **Hôte Quay** | Quay hostname | `quay.io` |
| **Namespace** | Organization or username | `myorganization` |
| **Nom d'utilisateur du compte robot** | Robot account username | `myorganization+deploy_robot` |
| **Jeton du compte robot** | Robot account token | `*****` |
...
**Related:** [Container Image Scanning](/v103/container-scanning/container-image-scanning) · [GitHub Container Registry](/v103/container-scanning/registry-integrations/github-container-registry) · [Docker Hub](/v103/container-scanning/registry-integrations/docker-hub)
