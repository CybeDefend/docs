...
<Frame>
  <img src="/images/get-started/free-plan-demo.png" alt="Free Plan & Demo" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
1. **Create a CybeDefend Account**  
   Learn how to register and set up your user profile at [Create Your Account](/get-started/how-to-create-account).

2. **Link Your Repository**  
   Follow our instructions to integrate your Git provider at [Repository Setup](/get-started/how-to-link-your-repository).

3. **Configure Your Scan Parameters**  
   Customize scanning frequency, severity, and more at [Scan Project Parameters](/get-started/general-information/scan-parameters).

4. **Request a Live Demonstration**  
   Schedule time for a hands-on tour of the CybeDefend dashboard and scanning features at [Book a Demo](/get-started/book-demo).
