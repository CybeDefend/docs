...
<Frame>
  <img src="/images/get-started/never-stock-code.png" alt="Secure Container Scanning" style={{ borderRadius: '0.5rem' }} />
</Frame>

## On-Premise Scanner Option (see [Roadmap](https://progress.cybedefend.com)). 
